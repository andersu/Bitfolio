...
internal class SlidingTabStrip @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    init {
        ...
        val themeForegroundColor = ContextCompat.getColor(context, R.color.white)
    ...
    fun onViewPagerPageChanged(position: Int, positionOffset: Float) {
        for (i in 0 until childCount) {
            ...
            child.alpha = if (i == position) 1f else DEFAULT_INACTIVE_ITEM_ALPHA
        }
    ...
    companion object {
        ...
        private const val DEFAULT_SELECTED_INDICATOR_COLOR = Color.WHITE

        private const val DEFAULT_DIVIDER_THICKNESS_DIPS = 1
        private const val DEFAULT_DIVIDER_COLOR_ALPHA: Byte = 0x0
        private const val DEFAULT_DIVIDER_HEIGHT = 0.5f

        private const val DEFAULT_INACTIVE_ITEM_ALPHA = 0.25f
